...
import org.lanqiao.educationaladministrationsystem.dto.EasStudent.StudentDelete;
...
public class StudentController {
    ...
    public ResponseUtil delete(@RequestBody StudentDelete studentDelete){
        try {
    ...
    public ResponseUtil selectBypageLike(@RequestBody StudentPageList studentPageList){
        System.out.println(studentPageList);
